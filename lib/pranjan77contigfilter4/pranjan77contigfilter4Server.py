...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'pranjan77contigfilter4'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from pranjan77contigfilter4.pranjan77contigfilter4Impl import pranjan77contigfilter4
impl_pranjan77contigfilter4 = pranjan77contigfilter4(config)
...
async_run_methods = {}
async_check_methods = {}
async_run_methods['pranjan77contigfilter4.filter_contigs_async'] = ['pranjan77contigfilter4', 'filter_contigs']
async_check_methods['pranjan77contigfilter4.filter_contigs_check'] = ['pranjan77contigfilter4', 'filter_contigs']
sync_methods['pranjan77contigfilter4.filter_contigs'] = True
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'pranjan77contigfilter4'
        ...
        self.rpc_service.add(impl_pranjan77contigfilter4.filter_contigs,
                             name='pranjan77contigfilter4.filter_contigs',
                             types=[dict])
        self.method_authentication['pranjan77contigfilter4.filter_contigs'] = 'required'
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "pranjan77contigfilter4 but no authentication header was passed"
                            raise err
