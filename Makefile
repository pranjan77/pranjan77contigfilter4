SERVICE = pranjan77contigfilter4
SERVICE_CAPS = pranjan77contigfilter4
SPEC_FILE = pranjan77contigfilter4.spec
URL = https://kbase.us/services/pranjan77contigfilter4
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
